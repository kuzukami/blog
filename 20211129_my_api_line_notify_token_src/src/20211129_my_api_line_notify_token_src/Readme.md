...
example see https://medium.com/geekculture/get-started-with-aws-sam-and-asp-net-core-6d4eddddbb93
...
Execute unit tests
```
    cd "20211129_my_api_line_notify_token_src/test/20211129_my_api_line_notify_token_src.Tests"
    dotnet test
```
