...
namespace my_function_20211218_api_sabr_bb9
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Bb9 = apiInvokeResponseBody.Bb9;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.InningPitched = apiRequestBody.InningPitched;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_BB9,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_BB9 = "my_function_20211218_glb_sabr_bb9";
