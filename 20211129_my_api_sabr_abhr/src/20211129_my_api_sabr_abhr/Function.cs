...
namespace _20211129_my_api_sabr_abhr
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Abhr = apiInvokeResponseBody.Abhr;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_ABHR,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_ABHR = "20211129_my_glb_sabr_abhr";
