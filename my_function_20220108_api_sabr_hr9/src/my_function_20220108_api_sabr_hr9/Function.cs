...
namespace my_function_20220108_api_sabr_hr9
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Hr9 = apiInvokeResponseBody.Hr9;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_HR9,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_HR9 = "my_function_20220108_glb_sabr_hr9";
