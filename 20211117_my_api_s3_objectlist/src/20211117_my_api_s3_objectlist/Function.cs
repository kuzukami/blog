...
namespace _20211117_my_api_s3_objectlist
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                if(apiInvokeResponseHeader.ResultCode != ApiUtil.RESULT_CODE_SUCCESS){
                    throw new System.Exception();
                }

                List<ApiInvokeResponseBody> apiInvokeResponseBodyList = JsonSerializer.Deserialize<List<ApiInvokeResponseBody>>(invokeResult.Body, ApiUtil.GetJsonSerializerOptionsDefault());
                ...
                foreach(ApiInvokeResponseBody apiInvokeResponseBody in apiInvokeResponseBodyList)
                {
                    apiResponseBody = new ApiResponseBody();
                    
                    apiResponseBody.BucketName       = apiInvokeResponseBody.BucketName;
                    apiResponseBody.ETag             = apiInvokeResponseBody.ETag;
                    apiResponseBody.Key              = apiInvokeResponseBody.Key;
                    apiResponseBody.LastModified     = apiInvokeResponseBody.LastModified;
                    apiResponseBody.OwnerDisplayName = apiInvokeResponseBody.OwnerDisplayName;
                    apiResponseBody.OwnerId          = apiInvokeResponseBody.OwnerId;
                    apiResponseBody.Size             = apiInvokeResponseBody.Size;
                    apiResponseBody.StorageClass     = apiInvokeResponseBody.StorageClass;
                    
                    apiResponseBodyList.Add(apiResponseBody);
                }
                ...
                apiResponse.Body = JsonSerializer.Serialize(apiResponseBodyList);
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.Prefix       = apiRequestBody.Prefix;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_S3_OBJECTLIST,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_S3_OBJECTLIST = "20211117_my_glb_s3_objectlist";
