...
namespace my_function_20220115_api_deepl
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Text = apiInvokeResponseBody.Text;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.TargetLang   = apiRequestBody.TargetLang;
                apiInvokeRequestBody.Text         = apiRequestBody.Text;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_DEEPL,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_DEEPL = "my_function_20220115_glb_deepl";
