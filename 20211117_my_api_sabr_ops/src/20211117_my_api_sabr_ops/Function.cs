...
namespace _20211117_my_api_sabr_ops
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Ops = apiInvokeResponseBody.Ops;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.AtBat        = apiRequestBody.AtBat;
                apiInvokeRequestBody.SacrificeFly = apiRequestBody.SacrificeFly;
                apiInvokeRequestBody.Walks        = apiRequestBody.Walks;
                apiInvokeRequestBody.DeadBall     = apiRequestBody.DeadBall;
                apiInvokeRequestBody.Single       = apiRequestBody.Single;
                apiInvokeRequestBody.Double       = apiRequestBody.Double;
                apiInvokeRequestBody.Triple       = apiRequestBody.Triple;
                apiInvokeRequestBody.HomeRun      = apiRequestBody.HomeRun;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_OPS,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_OPS = "20211117_my_glb_sabr_ops";
