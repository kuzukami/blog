...
namespace my_function_20211218_api_sabr_k9
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.K9 = apiInvokeResponseBody.K9;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_K9,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_K9 = "my_function_20211218_glb_sabr_k9";
