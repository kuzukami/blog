...
namespace _20211115_my_api_idealgaslaw
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Mol     = apiInvokeResponseBody.Mol;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_IDEALGASLAW,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_IDEALGASLAW = "20211115_my_glb_idealgaslaw";
