...
namespace _20211115_my_api_unitchange
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Message    = apiInvokeResponseBody.Message;
                apiResponseBody.Pressure   = apiInvokeResponseBody.Pressure;
                apiResponseBody.Volume     = apiInvokeResponseBody.Volume;
                apiResponseBody.Temperture = apiInvokeResponseBody.Temperture;
            ...
            catch (System.Exception e)
            {
                ...
                apiResponseBody.Pressure      = " ";
                apiResponseBody.Volume        = " ";
                apiResponseBody.Temperture    = " ";
                apiResponse.Body              = JsonSerializer.Serialize(apiResponseBody);
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.Pressure     = apiRequestBody.Pressure;
                apiInvokeRequestBody.Volume       = apiRequestBody.Volume;
                apiInvokeRequestBody.Temperture   = apiRequestBody.Temperture;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_UNITCHANGE,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_UNITCHANGE = "20211115_my_glb_unitchange";
