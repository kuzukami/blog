...
namespace my_function_20211207_api_sabr_kbb
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Kbb = apiInvokeResponseBody.Kbb;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.Strikeout    = apiRequestBody.Strikeout;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_KBB,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_KBB = "my_function_20211207_glb_sabr_kbb";
