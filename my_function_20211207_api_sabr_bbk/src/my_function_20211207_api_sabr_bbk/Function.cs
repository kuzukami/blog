...
namespace my_function_20211207_api_sabr_bbk
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Bbk = apiInvokeResponseBody.Bbk;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_SABR_BBK,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_SABR_BBK = "my_function_20211207_glb_sabr_bbk";
