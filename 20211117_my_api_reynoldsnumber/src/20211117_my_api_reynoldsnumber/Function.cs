...
namespace _20211117_my_api_reynoldsnumber
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.Reynoldsnumber = apiInvokeResponseBody.Reynoldsnumber;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.FlowVelocity       = apiRequestBody.FlowVelocity;
                apiInvokeRequestBody.Diameter           = apiRequestBody.Diameter;
                apiInvokeRequestBody.KinematicViscosity = apiRequestBody.KinematicViscosity;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_REYNOLDSNUMBER,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_REYNOLDSNUMBER = "20211117_my_glb_reynoldsnumber";
