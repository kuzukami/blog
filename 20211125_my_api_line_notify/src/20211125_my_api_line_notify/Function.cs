...
namespace _20211125_my_api_line_notify
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                string lineNotifyResponse = LineNotify().Result;
        ...
        private async Task<string> LineNotify()
        {
            try
            {
                ...
                string message  = "hello! this is nomurabbit.";
                ...
                request.RequestUri = new Uri("https://notify-api.line.me/api/notify");
    ...
    #endregion line notify response
}
