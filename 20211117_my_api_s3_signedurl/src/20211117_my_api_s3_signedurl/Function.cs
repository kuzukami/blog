...
namespace _20211117_my_api_s3_signedurl
{
    public class Function
    {
        public ApiResponse FunctionHandler(object input, ILambdaContext context)
        {
            try
            {
                ...
                apiResponseBody.SignedUrl = apiInvokeResponseBody.SignedUrl;
        ...
        private ApiInvokeRequest GetInvokePayload(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                apiInvokeRequestBody.Key          = apiRequestBody.Key;
        ...
        private async Task<string> InvokeAccess(ApiRequestBody apiRequestBody)
        {
            try
            {
                ...
                {
                    FunctionName   = ApiUtil.MY_GLB_S3_SIGNEDURL,
    ...
    public static class ApiUtil
    {
        ...
        public const string MY_GLB_S3_SIGNEDURL = "20211117_my_glb_s3_signedurl";
